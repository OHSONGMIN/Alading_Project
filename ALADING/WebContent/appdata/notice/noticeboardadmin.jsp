				...
				<tr>
					<td colspan="4">
						<ol class="paging">
							...
							<c:if test="${pvo.beginPage != 1 }">
								<li><a href="noticeboardadmin?cPage=${pvo.beginPage - 1 }"><<</a>
								</li>
							</c:if>
							...
							<c:if test="${cPage != 1 && cPage != null}">
								<li><a href="noticeboardadmin?cPage=${cPage - 1 }"><</a></li>
							</c:if>
							...
							<c:forEach var="pageNo" begin="${pvo.beginPage }"
								...
								<c:if test="${pageNo != pvo.nowPage }">
									<li><a
										href="noticeboardadmin?cPage=${pageNo }&size=${size}">${pageNo }</a>
									</li>
								</c:if>
							...
							<c:if test="${cPage != pvo.totalPage}">
								<li><a
									href="noticeboardadmin?cPage=${cPage + 1 }&size=${size}">></a>
								</li>
							</c:if>
							...
							<c:if test="${pvo.endPage < pvo.totalPage }">
								<li><a
									href="noticeboardadmin?cPage=${pvo.endPage + 1 }&size=${size}">>></a>
								</li>
							</c:if>
						</ol>
