		...
		<form action="noticewrite" method="post">
			...
			<div class="form-group">
				<div class="type-container">
					<label for="type" class="label"></label> <select name="type"
						class="select-field">
			...
			<div class="form-group">
				<label for="title" class="label"></label><br /> <input type="text"
					id="title" placeholder=" 제목을 입력하세요" class="input-field"
					name="title"><br />
			</div>
			...
			<div class="form-group">
				...
				<textarea id="contents" placeholder=" 내용을 입력하세요"
					class="textarea-field" name="contents"></textarea>
				<br />
			</div>
